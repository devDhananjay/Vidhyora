    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium">Default seller commission</label>
      ...
      <CommerceSettingsForm initialData={site.data} />

      <IntegrationsSettingsForm initialData={site.data} />
    </div>
  );
}

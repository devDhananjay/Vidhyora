...
export const aiProductDraftSchema = z.object({
  ...
  returnAllowed: z.boolean().optional().nullable(),
  returnWindowDays: z.number().int().min(0).max(365).optional().nullable(),
  replacementAllowed: z.boolean().optional().nullable(),
  replacementWindowDays: z.number().int().min(0).max(365).optional().nullable(),
